    ...
    <div class="dark:bg-red-1 h-full xl:px-74p px-5 pt-30p xl:pt-14">
        <div>
            <div class="flex items-center">
                <span class="ltr:mr-4 rtl:ml-4 lg:mt-0 mt-1">
                ...
                <form class="w-full" action="{{ route('site.addressUpdate', ['id' => $address->id]) }}" method="post">
                    ...
                    <div class="grid grid-cols-2 lg:gap-3 gap-15p">
                        <div class="lg:mb-3 mb-3.5">
                            ...
                            <input class="border-gray-2 rounded-sm mt-1.5 lg:mt-1p w-full lg:h-46p h-10 roboto-medium font-medium text-sm text-gray-10 form-control border focus:border-gray-12 ltr:pl-18p rtl:pr-18p"type="text" id="first_name" name="first_name" value="{{ !empty(old('first_name')) ? old('first_name') : $address->first_name }}"required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        </div>
                        <div class="lg:mb-3 mb-3.5">
                            <label class="text-sm dm-sans font-medium capitalize text-gray-12" for="last_name">{{ __('Last Name') }}</label>
                            <input class="border-gray-2 rounded-sm w-full mt-1.5 lg:mt-1p lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12" id="last_name" name="last_name"
                    ...
                    <div class="lg:mb-3 mb-3.5">
                        ...
                        <input class="border-gray-2 rounded-sm w-full mt-1.5 lg:mt-1p lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12"type="text" name="company_name" id="company_name" value="{{ !empty(old('company_name')) ? old('company_name') : $address->company_name }}">
                    </div>
                    <div class="grid lg:grid-cols-2 grid-cols-1 flex lg:gap-3">
                        <div class="order-2 lg:order-none lg:mb-3 mb-3.5  ">
                            ...
                            <input class="border-gray-2 rounded-sm mt-1.5 lg:mt-1p w-full lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12" type="text" id="phone" name="phone" value="{{ !empty(old('phone')) ? old('phone') : $address->phone }}" required
                        ...
                        <div class="order-first lg:order-none lg:mb-3 mb-3.5">
                            ...
                            <input class="border-gray-2 mt-1.5 lg:mt-1p rounded-sm w-full lg:h-46p h-10 ltr:pl-18p rtl:pr-18p roboto-medium font-medium text-sm text-gray-10 form-control focus:border-gray-12" type="email" name="email" id="email" value="{{ !empty(old('email')) ? old('email') : $address->email }}" data-type-mismatch="{{ __('Enter a valid :x.', ['x' => strtolower(__('Email'))]) }}">
                        </div>
                    </div>
                    <div class="lg:mb-3 mb-3.5">
                        <label class="text-sm dm-sans font-medium capitalize text-gray-12 require-profile" for="address_1"> {{ __('Street Address 1') }}</label>
                        <input id="address_1" name="address_1" type="text" value="{{ !empty(old('address_1')) ? old('address_1') : $address->address_1 }}" placeholder="{{ __('Address Line 1') }}" class="border-gray-2 rounded-sm w-full lg:h-46p h-10 roboto-medium mt-2 lg:mt-3p ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                    </div>
                    <div class="lg:block hidden lg:mb-3 mb-3.5">
                        ...
                        <input id="address_2" name="address_2" type="text" value="{{ !empty(old('address_2')) ? old('address_2') : $address->address_2 }}" placeholder="{{ __('Address Line 2') . ' (' . __('optional') . ')' }}" class="border-gray-2 rounded-sm w-full capitalize h-46p roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12">
                    </div>
                    <div class="grid grid-cols-2 lg:gap-3 lg:mb-3 mb-3.5 gap-15p">
                        <div class="w-full validSelect">
                            ...
                            <select name="country" id="country" class="border-gray-2 mt-1.5 lg:mt-1p rounded-sm w-full lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12 block addressSelect" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        ...
                        <div class="w-full validSelect">
                            ...
                            <select name="state" id="state" class="border-gray-2 mt-1.5 lg:mt-1p rounded-sm w-full lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12 block addressSelect" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                    ...
                    <div class="grid grid-cols-2 lg:gap-3 gap-15p">
                        <div class="lg:mb-3 mb-3.5 validSelect">
                            ...
                            <select name="city" id="city" class="border-gray-2 rounded-sm w-full lg:h-46p mt-1.5 lg:mt-1p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12 block addressSelect" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        ...
                        <div class="lg:mb-3 mb-3.5">
                            ...
                            <input id="zip" name="zip" type="text" maxlength="10" value="{{ !empty(old('zip')) ? old('zip') : $address->zip }}" class="border-gray-2 lg:mt-1p rounded-sm w-full h-46p roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12">
                        </div>
                    </div>
                            ...
                            <div class="radio-buttons">
                                <label class="custom-radio">
                                    ...
                                    <span class="radio-btn lg:w-141p lg:h-53p border border-gray-2 rounded dm-sans cursor-pointer relative inline-block font-medium text-center lg:text-sm text-xs ltr:pl-18p rtl:pr-18p text-gray-10">
                                        <svg class="ltr:mr-13p rtl:ml-13p neg-transition-scale absolute opacity-0 lg:my-22p mt-15p" xmlns="http://www.w3.org/2000/svg" width="11" height="9" viewBox="0 0 11 9" fill="none">
                                        ...
                                        <div class="ltr:lg:ml-18p ltr:ml-2 rtl:lg:mr-18p rtl:mr-2">
                                            <div class="flex items-center"><svg class=" my-18p lg:block hidden" xmlns="http://www.w3.org/2000/svg" width="16" height="18" viewBox="0 0 16 18" fill="none">
                                                ...
                                                </svg><span class="lg:my-0 my-3 ltr:ml-2 ltr:lg:mr-0 ltr:mr-9 rtl:mr-2 rtl:lg:ml-0 rtl:ml-9">{{ __('Home') }}</span>
                                            </div>
                                        </div>
                                    </span>
                                </label>
                                <label class="custom-radio ltr:ml-2 rtl:mr-2">
                                    ...
                                    <span class="radio-btn lg:w-141p lg:h-53p border border-gray-2 rounded dm-sans cursor-pointer relative inline-block font-medium text-center lg:text-sm text-xs ltr:pl-18p rtl:pr-18p text-gray-10">
                                        ...
                                        <div class="ltr:ml-2 ltr:lg:ml-18p rtl:mr-2 rtl:lg:ml-18p">
                                            <div class="flex items-center">
                                                ...
                                                </svg><span class="lg:my-0 my-3 ltr:ml-2 ltr:lg:mr-0 ltr:mr-9 rtl:mr-2 rtl:lg:ml-0 rtl:ml-9">{{ __('Office') }}</span>
                                            </div>
                                        </div>
                                    </span>
                                </label>
                    ...
                    @if ($address->is_default == 0)
                        <div class="form-check lg:mt-5 mt-6">
                            ...
                            <input name="is_default" class="h-4 w-4 border border-gray-2 rounded-sm bg-white text-gray-12 transition duration-200 mt-1 align-top t ltr:mr-2 rtl:ml-2 cursor-pointer neg-transition-scale" type="checkbox" value="1" id="flexCheckDefault">
                    ...
                    <div class="flex gap-3 lg:mt-5 mt-6">
                        <button class="lg:order-none order-last dm-sans text-center transition duration-200 rounded py-3.5 cursor-pointer font-medium text-sm text-gray-12 w-141p h-46p bg-white border border-gray-2 mb-7p hover:border-gray-12"><a href="{{ route('site.address') }}"> {{ __('Cancel') }}</a>
                        </button>
                        <button type="submit" id="btnSubmit" class="dm-sans transition duration-200 items-center cursor-pointer py-3 px-6 font-medium text-sm whitespace-nowrap text-white bg-gray-12 hover:bg-yellow-1 hover:text-gray-12 mb-7p rounded">{{ __('Save Address') }}</button>
                    </div>
                </form>
            </div>
        </div>
