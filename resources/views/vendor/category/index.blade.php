        ...
        <div class="card">
            <div class="card-header d-md-flex justify-content-between align-items-center">
                ...
                <div class="d-md-flex justify-content-end align-items-center">
                    ...
                    <div>
                        <button
                            class="btn btn-outline-primary mb-0 ltr:me-0 rtl:ms-0 custom-btn-small sub-category">{{ __('New :x', ['x' => __('Sub Category')]) }}</button>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5" id="formBlock">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="{{ __('Name') }}" class="form-control form-width inputFieldDesign" id="name" name="name" required minlength="3" oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" data-min-length="{{ __(':x should contain at least :y characters.', ['x' => __('Name'), 'y' => 3]) }}" data-related="slug" value="{{ old('name') }}">
                                                <label for="has_category" class="control-label display_none" id="has_category"></label>
                                            </div>
                                        </div>
                                        <input type="hidden" name="type" id="type" value="store">
                                        @if (in_array('App\Http\Controllers\Vendor\CategoryController@edit', $prms))
                                        ...
                                        <div class="form-group row" id="parentBlock">
                                            <label for="parent_id"
                                                   class="control-label ltr:ps-3 rtl:pe-3">{{ __('Parent Category') }}</label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="is_searchable"
                                                   class="control-label ltr:ps-3 rtl:pe-3">{{ __('Is Searchable') }}</label>
                                            <div class="col-sm-12">
                                                <select class="form-control select2-hide-search inputFieldDesign"
                                        ...
                                        <div class="form-group row">
                                            <label for="is_features"
                                                   class="control-label ltr:ps-3 rtl:pe-3">{{ __('Is Featured') }}</label>
                                            <div class="col-sm-12">
                                                <select class="form-control select2-hide-search inputFieldDesign"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="ltr:ps-3 rtl:pe-3" id="img-container">
                                        ...
                                        <div class="d-flex p-0 mt-2">
                                            ...
                                            @if (in_array('App\Http\Controllers\Vendor\CategoryController@destroy', $prms))
                                                <a href="javascript:void(0)"
                                                   class="btn custom-btn-cancel delete all-cancel-btn">{{ __('Delete') }}</a>
                                            @endif

                                            @if (array_intersect(
                                                ['App\Http\Controllers\Vendor\CategoryController@store', 'App\Http\Controllers\Vendor\CategoryController@update'],
                                                $prms))
                                                ...
                                                <div class="fixSize">
                                                    <a class="cursor_pointer" href="javascript:void(0)"
                                                       data-lightbox="image-1"> <img
                                                            class="profile-user-img img-responsive fixSize neg-transition-scale" src=''
...
@section('js')
    <script>
        var isAllowSuggestion = '{{ preference('system_suggestion') }}'
    </script>
