...
<div class="col-sm-12" id="item-import-container">
    <div class="card Recent-Users">
        <div class="card-header">
            <h5><a href="{{ route('product.index') }}">{{ __('Products') }}</a> >> {{ __('Import') }}</h5>
        </div>
        <div class="card-body p-0">
            <div class="col-sm-12">
                <div class="card-block pt-2">
                                    ...
                                    <div class="require-section position-relative">
                                        ...
                                        <table class="table table-bordered mb-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li>{{ __('Your product price will be here.') }}</li>
                                                        <li>{{ __('Example') }}: 99</li>
                                                    </ul>
                                                </td>
                                            </tr>
                    ...
                    <form action="{{ route('product.import') }}" method="post" id="myform1" class="form-horizontal"
                        ...
                        <div class="col-sm-8 px-0 mt-3">
                            ...
                            <a href="{{ route('product.index') }}" class="btn btn-danger custom-btn-small">{{ __('Cancel') }}</a>
                        </div>
                        <!-- /.box-footer -->
                    </form>
                </div>
                ...
                <table id="myTable" class="table table-bordered myTable">
                    ...
                    <tbody>
                        @foreach ($attributes as $attribute)
                            @php
                                $catIds = optional($attribute->categoryAttribute)->pluck('category_id')
                            @endphp
                            <tr>
                                <td>{{ $attribute->id }}</td>
