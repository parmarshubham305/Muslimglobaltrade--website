...
class BrandDetailResource extends JsonResource
{
    ...
    public function toArray($request = [])
    {
        ...
        if (isset($this->image->file_name) && ! empty($this->image->file_name) && file_exists('uploads/brand/' . $this->image->file_name)) {
            $pictureURL  = url('uploads/brand/' . $this->image->file_name);
