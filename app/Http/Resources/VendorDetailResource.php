...
class VendorDetailResource extends JsonResource
{
    ...
    public function toArray($request = [])
    {
        ...
        if (isset($this->avatarFile->file_name) && ! empty($this->avatarFile->file_name) && file_exists('uploads/vendor/' . $this->avatarFile->file_name)) {
            $pictureURL  = url('uploads/vendor/' . $this->avatarFile->file_name);
