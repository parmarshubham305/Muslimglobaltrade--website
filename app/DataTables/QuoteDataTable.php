...
class QuoteDataTable extends DataTable
{
    ...
    */
    ...
    {
        $inquiry = Quote::with(['user', 'product'])->filter();
    ...
    */
    public function html()
    {
        return $this->builder()
            ...
            ->addColumn(['data' => 'quantity', 'name' => 'quantity', 'title' => __('Quantity'), 'orderable' => false, 'searchable' => false, 'className' => 'align-middle text-left', 'width' => '12%'])
            ->addColumn(['data' => 'preferred_unit_price', 'name' => 'preferred_unit_price', 'title' => __('Preferred Unit Price'), 'orderable' => false, 'searchable' => false, 'className' => 'align-middle text-left', 'width' => '12%'])
