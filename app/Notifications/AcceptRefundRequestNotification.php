...
class AcceptRefundRequestNotification extends Notification
{
     ...
     * Notification Label
     */
    public static $label = 'Accept Refund Request';
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'message' => 'Your request for the refund of the product: ' . self::$product?->name . ' is complete',
        ];
    }
    ...
    public function toAdmin(object $notifiable): array
    {
        return [
            ...
            'message' => 'The refund request for the product ' . self::$product?->name . ", made by $notifiable->name, has been accepted.",
        ];
    }
    ...
    public function toSms(object $notifiable): array
    {
        return [
            'to' => $notifiable->phone,
            'message' => $this->getSmsData('accept-refund-request'),
        ];
    }
