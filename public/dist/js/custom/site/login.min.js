"use strict";$("#loginForm").on("submit",function(a){a.preventDefault(),$("#signin-user").find(".signin-text").hide(),$("#signin-user").addClass("auth-active-btn"),$(".login-modal-loader").css("display","inline"),setDialCode(".phone-email-box",".phone-email-box input[name=\"phone\"]"),$.ajax({url:SITE_URL+"/authenticate",type:"post",data:new FormData(this),dataType:"JSON",contentType:!1,cache:!1,processData:!1,success:function(a){if(1==a.status){if($(".login-message").removeClass("border border-reds-3"),$(".login-message").addClass("bg-green-2 p-7p md:p-2.5 md:pt-15p mb-3 md:mb-6 rounded border border-green-1 md:h-52p").html(`
