...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('modules/mediamanager/css/style.min.css') }}">
...
@section('js')
    ...
    <script src="{{ asset('modules/mediamanager/js/media-manager.min.js') }}"></script>
@endsection
