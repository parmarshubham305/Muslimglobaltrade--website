...
@section('content')
    <div id="vendor-coupon-edit-container">
        <div class="card">
                ...
                <div class="col-lg-9 col-12 ltr:ps-0 rtl:pe-0">
                    <div class="card card-info shadow-none">
                        <div class="card-header pt-4 border-bottom">
                            <h5><a href="{{ route('vendor.coupons') }}">{{ __('Coupon') }} </a> >> <span
                                    id="theme-title"></span></h5>
                        </div>

                        <div class="card-body">
                            <form action="{{ route('vendor.couponUpdate', ['id' => $coupon->id]) }}" method="post"
                                ...
                                <div class="tab-content p-0 box-shadow-unset" id="topNav-v-pills-tabContent">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group row" id="max_discount">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" step="any"
                                                            ...
                                                            class="form-control " id="maximum_discount_amount"
                                                            max="99999999" name="maximum_discount_amount"
                                                            data-max="{{ __('The value must be :x than or equal to :y.', ['x' => __('less'), 'y' => 99999999]) }}"
                                                            value="{{ !empty(old('maximum_discount_amount')) ? formatCurrencyAmount(old('maximum_discount_amount')) : formatCurrencyAmount($coupon->maximum_discount_amount) }}">
                                                    </div>
                                                </div>

                                                <div class="form-group row -mt-6">
                                                    <label class="col-sm-2 control-label text-left"
                                                        for="">{{ __('Allow free shipping') }}</label>
                                                    <div class="col-md-6 col-12">
                                                        <div class="switch switch-bg d-inline m-r-10">
                                                            <input class="is_default" name="allow_free_shipping"
                                                                value="" type="checkbox" id="free_shipping"
                                                                {{ $coupon->allow_free_shipping ? 'checked' : '' }}>
                                                            <label for="free_shipping" class="cr"></label>
                                                        </div>
                                                        <small class="line-height-25"
                                                            for="">{{ __('Check this box if the coupon grants free shipping.') }}
                                                            {{ __('A free shipping method must be enabled in your shipping zone and require a valid free shipping coupon') }}
                                                            ({{ __(' see the Free Shipping Requires setting.') }}).</small>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <small class="line-height-25">{{ __('Check this box if the coupon grants free shipping.') }} {{ __('A free shipping method must be enabled in your shipping zone and require a valid free shipping coupon') }} ({{ __('see the Free Shipping Requires setting.') }}).</small>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-restriction" role="tabpanel"
                                        ...
                                        @if (isActive('Shop') ? false : false && $shops->count() > 0)
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <select class="form-control select2 sl_common_bx" id="shop_id"
                                                        ...
                                                        @foreach ($shops as $shop)
                                                            <option {{ $shop->id == $coupon->shop_id ? 'selected' : '' }}
                                        ...
                                        <input type="hidden" id="vendor_id"
                                            value="{{ optional($coupon->vendor)->id }}">
                                        <div class="form-group row">
                                            <label class="col-sm-2 control-label"
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 control-label text-left" for="minimum_spend">
                                                ...
                                                <span data-bs-toggle="popover" data-bs-placement="right"
                                                    data-bs-bs-trigger="hover"
                                                    data-bs-content="{{ __('You must spend more than or equal this amount to get coupon discount.') }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" placeholder="{{ __('Usage Limit') }}"
                                                    ...
                                                    value="{{ !empty(old('usage_limit')) ? old('usage_limit') : $coupon->usage_limit }}">
                                            </div>
                                        </div>
