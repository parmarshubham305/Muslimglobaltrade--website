...
@section('content')
    <div id="vendor-coupon-add-container">
        <div class="card">
                                ...
                                <div class="tab-content p-0 box-shadow-unset" id="topNav-v-pills-tabContent">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <small
                                                        class="line-height-25">{{ __('Check this box if the coupon grants free shipping.') }}
                                                        {{ __('A free shipping method must be enabled in your shipping zone and require a valid free shipping coupon') }}
                                                        ({{ __('see the Free Shipping Requires setting.') }}).</small>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-restriction" role="tabpanel"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <select class="form-control select2 sl_common_bx" id="shop_id"
                                                        name="shop_id">
                                                        <option disabled selected value="">{{ __('Select One') }}
                                                        </option>
                                        ...
                                        <input type="hidden" id="vendor_id"
                                            value="{{ auth()->user()?->vendor()?->vendor_id }}">
                                        <div class="form-group row">
                                            <label class="col-sm-2 control-label"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <a href="{{ route('vendor.coupons') }}"
                                                        class="py-2 form-submit custom-btn-cancel ltr:float-right ltr:me-2 rtl:float-left rtl:ms-2 coupon-submit-button">{{ __('Cancel') }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
