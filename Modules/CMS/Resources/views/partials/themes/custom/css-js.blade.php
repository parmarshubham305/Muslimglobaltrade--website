    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control custom" rows="8" name="custom[css]">@if (File::exists('Modules/CMS/css/user-custom.css')){{ File::get('Modules/CMS/css/user-custom.css') }}@endif</textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control custom" rows="8" name="custom[js]">@if (File::exists('Modules/CMS/js/user-custom.js')){{ File::get('Modules/CMS/js/user-custom.js') }}@endif</textarea>
                </div>
            </div>
        </div>
    </div>
